...
public class ResponseHandler {
   ...
   *
   * @param pendingIntent a PendingIntent that we received from Android Market that will create the new buy
   *                      page activity
   * @param intent        an intent containing a request id in an extra field that will be passed to the buy
